...
const plans = [
  {
    ...
    price: "₹ 799",
    description:
      "Perfect for individuals and small businesses needing a landing page.",
    features: [
      "1 page",
  ...
  },
  {
    ...
    price: "₹ 1,999",
    description:
      "Great for businesses that need a powerful and advanced website.",
    features: [
      "Up to 3 Pages",
      "Custom modern design",
      "Database (store user/data info)",
      "Login & Signup system",
  ...
  {
    name: "Large scale Website",
    price: "Custom",
    description:
      "Best for large businesses or startups needing advanced and scalable solutions.",
    features: [
      "Unlimited Pages",
